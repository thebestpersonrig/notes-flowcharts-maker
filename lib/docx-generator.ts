...
function body(text: string): Paragraph {
  return new Paragraph({
    ...
    children: [new TextRun({ text, size: 22, font: "Calibri", color: "444444" })],
  });
}
...
export async function generateDocx(notes: NotesContent): Promise<Buffer> {
  ...
  children.push(
    ...
    new Paragraph({
      ...
      spacing: { after: 100 },
      children: [new TextRun({ text: "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", color: ACCENT_LIGHT, size: 20, font: "Calibri" })],
    }),
    new Paragraph({
      alignment: AlignmentType.CENTER,
      spacing: { before: 200, after: 200 },
      children: [new TextRun({ text: notes.title, bold: true, color: ACCENT, size: 60, font: "Calibri" })],
    }),
    new Paragraph({
      alignment: AlignmentType.CENTER,
      spacing: { after: 100 },
    ...
    new Paragraph({
      ...
      children: [new TextRun({ text: new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" }), color: "888888", size: 24, font: "Calibri" })],
    }),
    new Paragraph({
      alignment: AlignmentType.CENTER,
      spacing: { before: 60 },
      children: [new TextRun({ text: `${notes.sections.length} Sections  ·  ${notes.key_terms.length} Key Terms  ·  ${notes.practice_problems?.length || 0} Practice Problems`, color: "AAAAAA", size: 20, font: "Calibri" })],
    }),
    new Paragraph({ spacing: { before: 1600 }, children: [] }),
    new Paragraph({
      alignment: AlignmentType.CENTER,
      children: [new TextRun({ text: "Generated by Learnix", color: ACCENT_LIGHT, size: 22, font: "Calibri", italics: true })],
    }),
          ...
          default: new Header({
            children: [
              new Paragraph({
                ...
                children: [
                  new TextRun({ text: `Learnix  ·  ${notes.title}`, color: "AAAAAA", size: 16, font: "Calibri", italics: true }),
                ],
              }),
            ],
          }),
            ...
            children: [
              new Paragraph({
                ...
                children: [
                  ...
                  new TextRun({ text: "  ·  Generated by Learnix", color: "CCCCCC", size: 14, font: "Calibri" }),
                ],
              }),
            ],
          }),
